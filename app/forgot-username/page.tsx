...
export default function ForgotUsernamePage() {
  ...
  async function requestUsername(event: FormEvent<HTMLFormElement>) {
    ...
    // We do not reveal whether the email exists or show the username on screen.

    // Later, this can call a secure server route or Supabase Edge Function

    // that emails the username to the account email using Resend.
    ...
    setTimeout(() => {
      ...
      setMessage(
        ...
        "If an HTBF account exists for that email, username recovery instructions will be sent. You can also sign in using your email address."
      ...
      <section className="mx-auto max-w-xl">
        ...
        <div className="rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-slate-200">
          ...
          <p className="mt-3 leading-7 text-slate-600">
            ...
            Enter the email address you used for HTBF. For privacy, we will not

            show usernames directly on this page.
