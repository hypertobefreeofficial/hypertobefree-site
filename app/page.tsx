        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-6 py-20 md:grid-cols-2 md:py-28">
            ...
            <div className="relative min-h-[360px] md:min-h-[470px]">
              <div className="absolute right-0 top-2 hidden h-[440px] w-full rounded-[2.5rem] bg-gradient-to-br from-sky-200 via-amber-100 to-orange-200 shadow-2xl shadow-blue-950/10 md:block md:w-[560px]">
              ...
              <div className="rounded-[2rem] border border-white/70 bg-white/90 p-5 shadow-xl shadow-blue-950/10 backdrop-blur-xl md:absolute md:left-0 md:top-12 md:w-[330px]">
                <div className="flex items-center gap-3">
              ...
              <div className="mt-5 rounded-[2rem] border border-white/70 bg-white/90 p-5 shadow-xl shadow-blue-950/10 backdrop-blur-xl md:absolute md:bottom-2 md:left-10 md:mt-0 md:w-[300px]">
