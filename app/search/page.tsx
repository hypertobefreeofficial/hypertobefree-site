...
export default function SearchPage() {
  ...
  function getCardTitle(story: StoryRow) {
    ...
    if (story.video_url) return "Watch this HTBF post";
              ...
              {filteredStories.map((story, index) => {
                ...
                return (
                  <VideoDiscoveryTile
                    ...
                    location={story.location || "Location not shared"}
...
function VideoDiscoveryTile({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 right-9 p-4 text-white">
      ...
      {hasVideo && (
        <div className="pointer-events-none absolute bottom-3 right-3 flex h-8 w-8 items-center justify-center rounded-full bg-white text-slate-950 shadow-md">
