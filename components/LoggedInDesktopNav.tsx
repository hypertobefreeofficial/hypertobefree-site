...
export default function LoggedInDesktopNav({
  ...
  return (
    <nav
      aria-label="Primary"
      className="logged-in-desktop-nav fixed inset-x-0 top-0 z-[60] hidden overflow-visible border-b border-slate-200/70 bg-white/95 backdrop-blur-xl supports-[padding:max(0px)]:pt-[env(safe-area-inset-top)] lg:block"
    >
      <div className="app-desktop-shell-inner flex h-[var(--app-desktop-nav-height)] w-full items-center justify-between gap-3 overflow-visible">
        <Link
          href="/feed"
        ...
        <div className="flex min-w-0 flex-1 items-center justify-end gap-0.5 overflow-visible sm:justify-center">
