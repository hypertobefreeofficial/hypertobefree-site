...
export default function StoryOverlayText({
  ...
  const x = readPercent(overlayX, 50);
  const y = readPercent(overlayY, 50);
  const quoteText =
  ...
  return (
    <div
      ...
      className={`absolute z-20 leading-snug ${getPointerClass(
        draggable
...
function readPercent(value: number | null | undefined, fallback: number) {
