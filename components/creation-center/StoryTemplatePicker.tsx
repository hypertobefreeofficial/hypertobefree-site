...
export default function StoryTemplatePicker({
  ...
  return (
    <section className="min-w-0 max-w-full">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className={`inline-flex items-center gap-1 rounded-full px-3 py-1.5 text-[11px] font-black ring-1 ${
              value === "none"
      ...
      <div className="mt-4 flex w-full max-w-full gap-4 overflow-x-auto px-0.5 pb-3 sm:grid sm:grid-cols-2 sm:overflow-visible lg:grid-cols-3">
        {creationCenterStoryTemplates.map((template) => {
          ...
          return (
            <button
              ...
              className={`group relative aspect-[4/3] w-52 shrink-0 overflow-hidden rounded-[1.25rem] bg-slate-900 text-left ring-2 transition sm:w-auto ${
                selected
            ...
            >
              ...
              <span className="absolute inset-0 bg-gradient-to-t from-[#031d3d]/90 via-transparent to-black/5" />
              ...
              <span className="absolute inset-x-3 bottom-3 z-10 drop-shadow-sm">
                <span className="block text-sm font-black text-white">
                  {template.label}
                </span>
                <span className="mt-0.5 line-clamp-1 block text-[10px] font-semibold leading-4 text-blue-50/90">
