...
export const ACCOUNT_DELETION_SESSION_TRANSITION_MIGRATION = {
  version: "20260830170000",
  filename:
    "20260830170000_account_deletion_session_transition_foundation_phase4c7b1e2c3b2b.sql",
  relativePath:
    "supabase/migrations/20260830170000_account_deletion_session_transition_foundation_phase4c7b1e2c3b2b.sql",
...
export const ACCOUNT_DELETION_REQUEST_PRIVILEGE_MIGRATION = {
  version: "20260919170000",
  filename:
    "20260919170000_account_deletion_request_privilege_hardening_phase4c7b1e2c3b2f2a1.sql",
  relativePath:
    "supabase/migrations/20260919170000_account_deletion_request_privilege_hardening_phase4c7b1e2c3b2f2a1.sql",
