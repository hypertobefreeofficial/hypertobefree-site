...
-- Apply on preview branch first. Do NOT apply to production until review.
...
-- ============================================================
-- 5) Remove legacy permissive inbox_messages policies
-- PostgreSQL ORs permissive policies; legacy policies must be
-- dropped or Phase 1 hardening is ineffective.
-- ============================================================

DROP POLICY IF EXISTS "Allow authenticated users to send inbox messages"
  ON public.inbox_messages;

DROP POLICY IF EXISTS "Users can send private prayer inbox replies"
  ON public.inbox_messages;

DROP POLICY IF EXISTS "Users can delete their own inbox messages"
  ON public.inbox_messages;

DROP POLICY IF EXISTS "Users can update their own inbox messages"
  ON public.inbox_messages;

DROP POLICY IF EXISTS "Users can view their own inbox messages"
  ON public.inbox_messages;

-- ============================================================
-- 6) inbox_messages RLS (Phase 1 hardened policies)
-- ============================================================
